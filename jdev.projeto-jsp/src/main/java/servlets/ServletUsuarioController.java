		...
		try {
			...
			if (acao != null && !acao.isEmpty() && acao.equalsIgnoreCase("deletar")) {
				...
				if (dataInicial == null || dataInicial.isEmpty() 
					...
					BeanDtoGraficoSalarioUser beanDtoGraficoSalarioUser  = daoUsuarioRepository.montarGrafioMediaSalario(super.getUserLogado(request));
					ObjectMapper mapper = new ObjectMapper();
					...
					BeanDtoGraficoSalarioUser beanDtoGraficoSalarioUser  = daoUsuarioRepository.montarGrafioMediaSalario(super.getUserLogado(request), dataInicial, dataFinal);
					ObjectMapper mapper = new ObjectMapper();
					String json = mapper.writeValueAsString(beanDtoGraficoSalarioUser);
